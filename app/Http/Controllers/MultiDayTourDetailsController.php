...
//dd($MultiDayTourDetails);
        return view('admin.multi_day_tours..createdetails', compact('multiDayTour','MultiDayTourDetails'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.multi_day_tours..editdetails', compact('MultiDayTourDetails'));
    }
