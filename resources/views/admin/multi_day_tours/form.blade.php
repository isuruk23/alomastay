        ...
        <div class="mb-3">
            ...
            <input type="text" name="name" class="form-control form-control-sm" value="{{ old('name', $multiDayTour->name ?? '') }}" >
            @if ($errors->has('name'))
        ...
        <div class="mb-3">
            ...
            <input type="text" name="discount" class="form-control form-control-sm" value="{{ old('discount', $multiDayTour->discount ?? '') }}" >
        ...
        <div class="mb-3">
            ...
            <textarea name="description" class="form-control form-control-sm" >{{ old('description', $multiDayTour->description ?? '') }}</textarea>
        ...
        <div class="mb-3">
            ...
            <input type="number" name="days" class="form-control form-control-sm" value="{{ old('days', $multiDayTour->days ?? 1) }}" >
            @if ($errors->has('days'))
        ...
        <div class="mb-3">
            ...
            <input type="number" name="nights" class="form-control form-control-sm" value="{{ old('nights', $multiDayTour->nights ?? 1) }}" >
        ...
        <div class="mb-3">
            ...
            <input type="text" name="price" class="form-control form-control-sm" value="{{ old('price', $multiDayTour->price ?? '') }}">
            @if ($errors->has('price'))
        ...
        <div class="mb-3">
            ...
            <input type="date" name="start_date" class="form-control form-control-sm" value="{{ old('start_date', $multiDayTour->start_date ?? '') }}">
        ...
        <div class="mb-3">
            ...
            <input type="date" name="end_date" class="form-control form-control-sm" value="{{ old('end_date', $multiDayTour->end_date ?? '') }}">
        ...
        <div class="mb-3">
            ...
            <textarea name="itinerary" id="itinerary" class="form-control form-control-sm">{{ old('itinerary', $multiDayTour->itinerary ?? '') }}</textarea>
        ...
        <div class="mb-3">
            ...
            <textarea name="includes" id="includes" class="form-control form-control-sm">{{ old('includes', $multiDayTour->includes ?? '') }}</textarea>
        ...
        <div class="mb-3">
            ...
            <textarea name="excludes" id="excludes" class="form-control form-control-sm">{{ old('excludes', $multiDayTour->excludes ?? '') }}</textarea>
        ...
        <div class="mb-3">
            ...
            <textarea name="conditions" id="conditions" class="form-control form-control-sm">{{ old('conditions', $multiDayTour->conditions ?? '') }}</textarea>
        ...
        <div class="mb-3">
            ...
            <textarea name="important" id="important" class="form-control form-control-sm">{{ old('important', $multiDayTour->important ?? '') }}</textarea>
        ...
        <div class="mb-3">
            ...
            <textarea name="tips" id="tips" class="form-control form-control-sm">{{ old('tips', $multiDayTour->tips ?? '') }}</textarea>
            @if ($errors->has('tips'))
        ...
        <div class="mb-3">
            ...
            <input class="form-control form-control-sm" type="file" id="banner" name="banner">
