...
<div class="container">
    ...
    <a href="{{ route('admin.thingstodo.create') }}" class="btn btn-primary mb-3">Add New admin.</a>
            ...
            <tbody>
                @foreach($thingstodos as $thingstodo)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.thingstodo.show', $thingstodo->id) }}" class="btn btn-info btn-sm">View</a>
                            <a href="{{ route('admin.thingstodo.edit', $thingstodo->id) }}" class="btn btn-warning btn-sm">Edit</a>
